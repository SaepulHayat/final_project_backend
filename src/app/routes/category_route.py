...
# @jwt_required() # Removed redundant decorator
@role_required(UserRoles.ADMIN) # Only Admins can create categories
...
# @jwt_required() # Removed redundant decorator
@role_required(UserRoles.ADMIN) # Only Admins can update categories
...
# @jwt_required() # Removed redundant decorator
@role_required(UserRoles.ADMIN) # Only Admins can delete categories
